...
import com.alienworkspace.testing.springtesting.integration.AbstractionContainerBaseTest;
...
public class EmployeeRepositoryTContainerITest extends AbstractionContainerBaseTest {
...
//    @DisplayName("JUnit test for save Employee Operation")
    ...
    public void givenEmployee_whenCallFindById_thenReturnAnEmployeeObject(){
        ...
        Employee employee = Employee.builder()
            ...
            assertThat(returnedEmployee.getId()).isGreaterThan(0L);
    }
